...
public class PaymentProcessView extends JDialog {
    ...
    private void initComponents() {
        ...
        jLabel10.setBackground(new Color(51, 51, 51));
        ...
        jLabel12.setBackground(new Color(51, 51, 51));
        ...
        jLabel14.setBackground(new Color(51, 51, 51));
        ...
        jLabel16.setBackground(new Color(51, 51, 51));
        ...
        btnPagoTarjeta.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
        gridBagConstraints = new GridBagConstraints();
        ...
        btnPagoTienda.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.insets = new Insets(0, 5, 0, 5);
        ...
        metodoPagoPanel.setBackground(new Color(0, 0, 0));
