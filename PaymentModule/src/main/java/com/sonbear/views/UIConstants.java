...
public interface UIConstants {
    ...
    public Icon DEFAULT_ROW_ICON = new ImageIcon(UIConstants.class.getClass().getResource("/right.gif"));
    public Icon DEFAULT_DELETE_ICON = new ImageIcon(UIConstants.class.getClass().getResource("/delete.png"));

    public TableCellRenderer DEFAULT_TABLE_HEADER_RENDERER = (table, value, isSelected, hasFocus, row, column) -> {
    ...
    public TableCellRenderer DEFAULT_TABLE_CELL_RENDERER = new DefaultTableCellRenderer() {
